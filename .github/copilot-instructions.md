...
1. **Maximum Quality**: No spaghetti code, no empty methods, no misleading pseudo-code. Code must compile, be logical, and avoid common pitfalls. No comments (#super plugin utilise alors la on fait ça et ça ) c'est moche et PAS DE .md ultra gros ou supprime les doublons 

...
public enum Lang {
  ...
  GUI_NATION_MEMBER_DESC1,
  GUI_NATION_CHANGE_CAPITAL,
  GUI_NATION_CHANGE_CAPITAL_DESC,
  GUI_NATION_DELETE,
  GUI_NATION_DELETE_DESC,
  ...
  NATION_COMMAND_DESC,
  NATION_CREATED_SUCCESS,
  NATION_CREATE_MISSING_NAME,
  NATION_CREATE_MUST_BE_REGION_LEADER,
  NATION_CREATE_REGION_ALREADY_HAS_NATION,
  NATION_DISBANDED_SUCCESS,
  NATION_DISBAND_MUST_BE_NATION_LEADER,
  NATION_NOT_ENABLED,
  NATION_NOT_ENOUGH_MONEY,
  NATION_WAR_DECLARED,
  NATION_WAR_DECLARED_NEWSLETTER,
  NATION_ALLIANCE_PROPOSAL,
  NATION_ALLIANCE_ACCEPTED,
  NATION_VASSAL_PROPOSAL,
  NATION_VASSAL_ACCEPTED,

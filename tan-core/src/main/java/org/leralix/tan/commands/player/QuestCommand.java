...
/**
 * Command to open the town quest menu.
 * Usage: /ccn quest
 */
public class QuestCommand extends PlayerSubCommand {
    ...
    public String getDescription() {
        return "Opens the town quest menu";
    }
    ...
    public void perform(Player player, String[] args) {
        PlayerDataStorage.getInstance().get(player)
                ...
                .thenAccept(townData -> {
                    ...
                    QuestListMenu.open(player, townData);
                });
    }
}

...
/**
 * Real WorldGuard-backed implementation of {@link WorldGuardService}.
 * <p>
 * This class contains hard imports to {@code com.sk89q.worldguard} and
 * {@code com.sk89q.worldedit} packages. It is loaded <b>only</b> via
 * reflection through {@link WorldGuardServiceFactory} so that the JVM never
 * attempts to resolve these classes when WorldGuard is absent.
 */
